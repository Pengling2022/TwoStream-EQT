...
class FrequencyEQTLit(SeisBenchModuleLit):
    """
    LightningModule for Two Stream EQT
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.logits = logits
        self.model = sbm.FrequencyEQT(cnn_blocks=self.cnn_blocks,
                                      res_cnn_blocks=self.res_cnn_blocks,
                                      lstm_blocks=self.lstm_blocks,
                                      drop_rate=self.drop_rate,
                                      eqt_mode=self.eqt_mode,
                                      logits=self.logits,
                                      **kwargs)
    ...
    def predict_step(self, batch, batch_idx=None, dataloader_idx=None):
        ...
        return score_detection, score_p_or_s, p_sample, s_sample
class TwoStreamEQTLit(SeisBenchModuleLit):
    """
    LightningModule for Two Stream EQT
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.eqt_mode = eqt_mode
        self.logits = logits
        self.model = sbm.TwoStreamEQT(cnn_blocks=self.cnn_blocks,
                                      res_cnn_blocks=self.res_cnn_blocks,
                                      lstm_blocks=self.lstm_blocks,
                                      drop_rate=self.drop_rate,
                                      eqt_mode=self.eqt_mode,
...
class CrossTwoStreamEQTLit(SeisBenchModuleLit):
    """
    LightningModule for Two Stream EQT
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.eqt_mode = eqt_mode
        self.logits = logits
        self.model = sbm.CrossTwoStreamEQT(cnn_blocks=self.cnn_blocks,
                                          res_cnn_blocks=self.res_cnn_blocks,
                                          lstm_blocks=self.lstm_blocks,
                                          drop_rate=self.drop_rate,
                                          eqt_mode=self.eqt_mode,
